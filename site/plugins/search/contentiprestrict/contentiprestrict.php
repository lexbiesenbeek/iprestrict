...
// @todo add check if search_content is still active?

class PlgSearchContentIprestrict extends JPlugin
{
    /**
    ...
    public function onContentSearch($text, $phrase = '', $ordering = '', $areas = null)
    {
        ...
        // check if ip restrictions have been set
        if ($app->getUserState('iprestriction', 0) == 1) {
            $whereIpRestriction = 'a.attribs NOT REGEXP(\'"iprestrict":"1"\')';
        } else {
            $whereIpRestriction = '';
        }
        ...
        switch ($phrase) {
            case 'exact':
                ...
                if ($whereIpRestriction) {
                    $where .= ' AND ' . $whereIpRestriction;
                }
                break;
